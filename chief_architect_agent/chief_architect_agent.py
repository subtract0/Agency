...
from tools import LS, Read, Grep, Glob, TodoWrite, Write, Edit, Bash, GitHubManager, ContextMessageHandoff
...
def create_chief_architect_agent(model: str = "gpt-5", reasoning_effort: str = "high", agent_context: AgentContext | None = None) -> Agent:
    ...
    return Agent(
        ...
        hooks=combined_hook,
        tools=[LS, Read, Grep, Glob, TodoWrite, Write, Edit, Bash, GitHubManager, ContextMessageHandoff, RunArchitectureLoop],
