...
class ConsolidateLearning(BaseTool):
    ...
    def _create_learning_object(self, insight: LearningPattern, context: LearningPattern) -> LearningPattern:
    ...
    def _determine_learning_type(self, insight: LearningPattern) -> str:
    ...
    def _extract_patterns(self, insight: PatternData) -> PatternData:
    ...
    def _generate_application_criteria(self, insight: LearningPattern, learning_type: str) -> List[str]:
    ...
    def _generate_success_metrics(self, insight: LearningPattern, learning_type: str) -> List[str]:
