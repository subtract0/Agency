...
class ExtractInsights(BaseTool):
    ...
    def _extract_tool_insights(self, analysis_data: AnalysisResult) -> List[AnalysisResult]:
    ...
    def _extract_error_insights(self, analysis_data: AnalysisResult) -> List[AnalysisResult]:
    ...
    def _extract_workflow_insights(self, analysis_data: AnalysisResult) -> List[AnalysisResult]:
    ...
    def _extract_optimization_insights(self, analysis_data: AnalysisResult) -> List[AnalysisResult]:
