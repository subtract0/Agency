...
class StoreKnowledge(BaseTool):
    ...
    def _store_single_learning(self, learning_data: LearningPattern, vector_store: VectorStore) -> str:
    ...
    def _store_batch_learnings(self, learning_data: LearningPattern, vector_store: VectorStore) -> str:
    ...
    def _update_existing_learning(self, learning_data: LearningPattern, vector_store: VectorStore) -> str:
    ...
    def _store_learning_object(self, learning_obj: LearningPattern, vector_store: VectorStore, update_mode: bool = False) -> bool:
    ...
    def _create_embedding_text(self, learning_obj: LearningPattern) -> str:
    ...
    def _get_storage_stats(self, vector_store: VectorStore) -> Any:
