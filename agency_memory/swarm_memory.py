...
class SwarmMemoryStore(MemoryStore):
    ...
    def __init__(
        ...
        """
        self._memories: Dict[str, AgentData] = {}
        self._agent_namespaces: Dict[str, Set[str]] = defaultdict(set)
        self._shared_knowledge: Dict[str, LearningData] = {}
        self._memory_summaries: Dict[str, LearningData] = {}
    ...
    def get_all(self, agent_id: str = None) -> List[AgentData]:
        """
    ...
    def get_agent_summary(self, agent_id: str) -> MemoryData:
        """
    ...
    def get_swarm_overview(self) -> MemoryData:
        """
...
class SwarmMemory(Memory):
    ...
    def get_summary(self, agent_id: Optional[str] = None) -> MemoryData:
    ...
    def get_shared_memories(self) -> List[DataModel]:
